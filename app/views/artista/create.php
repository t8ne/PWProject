        ...
        <div class="col-md-6"> <!-- Define a largura máxima da área de criação -->
            <div class="card mt-5"> <!-- Cria um cartão com margem superior -->
                <div class="card-body">
                    ...
                    <form action="<?php echo $url_alias; ?>/artista/create" method="POST"> <!-- Define o destino e método do formulário -->
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nacionalidade" name="nacionalidade" required> <!-- Campo obrigatório -->
                        </div>
