                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo $url_alias; ?>/musica/update/<?php echo $data['musica'][0]['id_musica']; ?>" method="POST">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nome" name="nome" value="<?php echo htmlspecialchars($data['musica'][0]['nome']); ?>" required>
                            </div>
                            <div class="mb-3">
                                <label for="tempo" class="form-label">Tempo:</label>
                                <input type="text" class="form-control" id="tempo" name="tempo" value="<?php echo htmlspecialchars($data['musica'][0]['tempo']); ?>" required>
                            </div>
                            <div class="mb-3">
